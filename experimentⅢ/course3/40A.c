...
while(1){
	...
	if(course == 100){
		...
		course = 102;
		rotate_tire( CW, CW, 1, 1, 40, 150*0.086*ONE_ROT);	
		goto LOOP1;
	}else if(course == 102){
		course = 103;
		rotate_tire( CW, CW, 0, 2, 80, ROT_90);	// 左へ90度回転する
		goto LOOP1;
	}else if(course == 103){
		course = 104;
		rotate_tire( CW, CW, 1, 1, 40, 30*0.086*ONE_ROT);
		goto LOOP1;
	}else if(course == 104){
		course = 105;
		...
		course = 106;
		rotate_tire( CW, CW, 1, 1, 40, 40*0.086*ONE_ROT);
		goto LOOP1;
	}else if(course == 106){
		course = 107;
		rotate_tire( CW, CW, 0, 2, 80, ROT_90);	// 左へ90度回転する
		...
		course = 108;
		rotate_tire( CW, CW, 1, 1, 40, 65*0.086*ONE_ROT);
		goto LOOP1;
	}else if(course == 108){
		course = 109;
		rotate_tire( CW, CW, 2, 0, 80, ROT_90);	// 右へ90度回転する
		goto LOOP1;
	}else if(course == 109){
		course = 110;
		rotate_tire( CW, CW, 1, 1, 40, 30*0.086*ONE_ROT);
		...
		course = 112;
		rotate_tire( CW, CW, 1, 1, 40, 36*0.086*ONE_ROT);
		goto LOOP1;
	}else if(course == 112){
		course = 113;
		rotate_tire( CW, CW, 0, 2, 80, ROT_90);	// 左へ90度回転する
		...
		course = 114;
		rotate_tire( CW, CW, 1, 1, 40, 70*0.086*ONE_ROT);
		goto LOOP1;
	}else if(course == 114){
		course = 115;
		rotate_tire( CW, CW, 0, 2, 80, ROT_90);	// 左へ90度回転する
