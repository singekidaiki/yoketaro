...
while(1){
	...
	if(course == 100){
		...
		course = 102;
		rotate_tire( CW, CW, 1, 1, 25, 75*0.086*ONE_ROT);	
		goto LOOP1;
	}else if(course == 102){
		course = 103;
		rotate_tire( CW, CW, 0, 2, 50, ROT_90);	// 左へ90度回転する
		goto LOOP1;
	}else if(course == 103){
		course = 104;
		rotate_tire( CW, CW, 1, 1, 25, 37.5*0.075*ONE_ROT);
		goto LOOP1;
	}else if(course == 104){
		course = 105;
		...
		course = 108;
		rotate_tire( CW, CW, 1, 1, 25, 75*0.075*ONE_ROT);
		goto LOOP1;
	}else if(course == 108){
		course = 109;
		rotate_tire( CW, CW, 0, 2, 50, ROT_90);	// 左へ90度回転する
